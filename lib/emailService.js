        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
          ...
          <div style="padding: 20px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              ...
              }/auth/login" style="background-color: #0d9488; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold;">Login to Your Account</a>
            </div>
...
export async function sendBookingConfirmationEmail(email, patientName, data) {
  try {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
        ...
        <div style="padding: 20px;">
          ...
          <div style="background-color: #f9fafb; padding: 15px; border-radius: 5px; margin: 20px 0;">
            <p style="margin: 10px 0;"><strong>Doctor:</strong> ${
              data.doctorName || "Not specified"
            }</p>
            ${
              data.doctorSpecialization
                ? `<p style="margin: 10px 0;"><strong>Specialization:</strong> ${data.doctorSpecialization}</p>`
                : ""
            }
            <p style="margin: 10px 0;"><strong>Service:</strong> ${
              data.serviceName || "Not specified"
            }</p>
            ...
            <p style="margin: 10px 0;"><strong>Payment Method:</strong> ${
            ...
            <p style="margin: 10px 0;"><strong>Appointment ID:</strong> ${
              data.appointmentId || "Not available"
            }</p>
            ${
              data.notes && data.notes !== "None"
                ? `<p style="margin: 10px 0;"><strong>Notes:</strong> ${data.notes}</p>`
                : ""
            }
          </div>
          ...
          <div style="background-color: #ecfdf5; padding: 15px; border-radius: 5px; margin: 20px 0;">
            ...
            <p style="margin: 5px 0; color: #065f46;"><strong>NoorX Center</strong></p>
            <p style="margin: 5px 0; color: #065f46;">123 Medical Avenue, Srinagar</p>
            <p style="margin: 5px 0; color: #065f46;">Jammu & Kashmir, India</p>
            <p style="margin: 5px 0; color: #065f46;"><em>Bringing comfort closer.</em></p>
          </div>
          ...
          <p>Thank you for choosing NoorX.</p>
          
          <p>Best regards,<br>NoorX Team</p>
        </div>
        ...
        <div style="background-color: #f3f4f6; padding: 15px; text-align: center; font-size: 12px; color: #6b7280; border-radius: 0 0 5px 5px;">
          ...
          <p>© 2023 NoorX. All rights reserved.</p>
        </div>
      </div>
    `;
    ...
    const mailOptions = {
      ...
      to: email,
      subject: "Appointment Confirmation - NoorX",
      html: emailContent,
    };
