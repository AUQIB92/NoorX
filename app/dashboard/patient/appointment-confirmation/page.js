          ...
          <>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">
                        {appointmentDetails.doctorName || "Not specified"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">
                        {appointmentDetails.serviceName || "Not specified"}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-3">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">
                        {appointmentDetails.time || "Not specified"}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="py-3">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">
                        {appointmentDetails.id || "Not available"}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                ...
                <ul className="space-y-3 text-blue-700">
                  ...
                  <li className="flex items-start">
                    ...
                    Wear a mask and follow COVID-19 safety protocols during your
                    visit.
                  </li>
                </ul>
              </div>
            ...
            <div className="p-8 flex flex-wrap gap-4 justify-center border-t border-gray-200">
              <Link
                ...
                className="inline-flex items-center px-6 py-3 bg-indigo-600 text-white font-medium rounded-lg shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                <FaCalendarAlt className="mr-2" /> View All Appointments
              </Link>
              <Link
                href="/dashboard/patient"
                className="inline-flex items-center px-6 py-3 bg-gray-200 text-gray-800 font-medium rounded-lg shadow-sm hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
              >
          ...
          <div className="p-8 text-center">
            <div className="bg-yellow-50 p-6 rounded-xl border-l-4 border-yellow-500 inline-block mx-auto text-left">
              ...
              <p className="text-yellow-700">
                We couldn't find details for your recent appointment.
              </p>
              <div className="mt-4">
                <Link
                  href="/dashboard/patient/appointments"
                  className="inline-flex items-center px-4 py-2 bg-yellow-600 text-white font-medium rounded-md shadow-sm hover:bg-yellow-700"
                >
